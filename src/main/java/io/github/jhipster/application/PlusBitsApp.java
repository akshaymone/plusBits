...
public class PlusBitsApp {

    private static final Logger log = LoggerFactory.getLogger(PlusBitsApp.class);

    private final Environment env;

    public PlusBitsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes plusBits.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PlusBitsApp.class);
